...
var iconMap = map[string]string{
	...
	"strokes":     "icon-[fa6-solid--person-swimming]",
	...
	"alpine-climbing": "icon-[map--climbing]",
	"mountaineering":  "icon-[fluent--mountain-trail-24-filled]",
	"horse-riding":    "icon-[mdi--horse-human]",
	"push-ups":        "icon-[hugeicons--push-up-bar]",
	"chin-ups":        "icon-[mdi--human-handsup]",
	"pull-ups":        "icon-[mdi--human-handsup]",
	"planking":        "icon-[game-icons--planks]",
